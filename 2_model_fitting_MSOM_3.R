...
cat(file="Butterfly_detection/jags_models/MSOM_3.txt", "model{
  ...
  for(o in 1:n_observer){
    alpha_obs[o] ~ dnorm(mu_alpha_obs, tau_alpha_obs)
  }
  mu_alpha_obs ~ dnorm(0, 0.0001) T(-12,12)
  tau_alpha_obs ~ dgamma(0.01,0.01)
...
save(jags_samples, file = "Data/models_fit/MSOM/MSOM_3_run1.RData")